...
export const mockProducts: Product[] = [
  // Coffee Based
  {
    ...
    imageUrl: '/coffee-based/spanish-latte.png',
    available: true,
    stock: 99,
    popular: true,
    displayOrder: 1,
  ...
  },
  {
    ...
    imageUrl: '/coffee-based/rush-coffee-blend.png',
    available: true,
    stock: 99,
    popular: true,
    displayOrder: 2,
  ...
  },
  {
    ...
    imageUrl: '/coffee-based/caramel-chocolate-mocha.jpg',
    available: true,
    stock: 99,
    popular: true,
    displayOrder: 3,
  ...
  },
  {
    ...
    imageUrl: '/coffee-based/dark-chocolate-mocha.jpg',
    available: true,
    stock: 99,
    displayOrder: 4,
  },
  {
    ...
    imageUrl: '/coffee-based/mocha-latte.jpg',
    available: true,
    stock: 99,
    displayOrder: 5,
  },
  {
    ...
    imageUrl: '/coffee-based/americano.jpg',
    available: true,
    stock: 99,
    displayOrder: 6,
  },
  {
    ...
    imageUrl: '/coffee-based/biscoff-latte.jpg',
    available: true,
    stock: 99,
    displayOrder: 7,
  },
  {
    ...
    imageUrl: '/coffee-based/reeses-latte.jpg',
    available: true,
    stock: 99,
    displayOrder: 8,
  },
  {
    ...
    imageUrl: '/coffee-based/brown-sugar-latte.jpg',
    available: true,
    stock: 99,
    displayOrder: 9,
  },
  {
    ...
    imageUrl: '/coffee-based/iced-latte.jpg',
    available: true,
    stock: 99,
    displayOrder: 10,
  },
  {
    ...
    imageUrl: '/coffee-based/orange-latte.jpg',
    available: true,
    stock: 99,
    displayOrder: 11,
  },
  ...
  // Non-Coffee Based
  {
    ...
    imageUrl: '/non-coffee/red-velvet.jpg',
    available: true,
    stock: 99,
    displayOrder: 13,
  },
  {
    ...
    imageUrl: '/non-coffee/red-velvet-matcha-latte.jpg',
    available: true,
    stock: 99,
    displayOrder: 14,
  },
  {
    ...
    imageUrl: '/non-coffee/milky-choco.jpg',
    available: true,
    stock: 99,
    displayOrder: 15,
  },
  {
    ...
    imageUrl: '/non-coffee/strawberry-milk.jpg',
    available: true,
    stock: 99,
    displayOrder: 16,
  },
  {
    ...
    imageUrl: '/non-coffee/biscoff-milky.jpg',
    available: true,
    stock: 99,
    displayOrder: 17,
  },
  {
    ...
    imageUrl: '/non-coffee/oreo-latte.jpg',
    available: true,
    stock: 99,
    displayOrder: 18,
  },
  ...
  // Matcha Series
  {
    ...
    imageUrl: '/matcha-series/matcha-latte.jpg',
    available: true,
    stock: 99,
    popular: true,
    displayOrder: 19,
  ...
  },
  {
    ...
    imageUrl: '/matcha-series/strawberry-matcha.jpg',
    available: true,
    stock: 99,
    displayOrder: 20,
  },
  {
    ...
    imageUrl: '/matcha-series/matcha-cream-cheese.jpg',
    available: true,
    stock: 99,
    displayOrder: 21,
  },
  {
    ...
    imageUrl: '/matcha-series/matcha-oreo.jpg',
    available: true,
    stock: 99,
    displayOrder: 22,
  },
  ...
  // Refreshments
  {
    ...
    imageUrl: '/refreshments/flamangooverload.jpg',
    available: true,
    stock: 99,
    displayOrder: 23,
  },
  {
    ...
    imageUrl: '/refreshments/mangoberry.jpg',
    available: true,
    stock: 99,
    displayOrder: 24,
  },
  {
    ...
    imageUrl: '/refreshments/mango-caramel.jpg',
    available: true,
    stock: 99,
    displayOrder: 25,
  },
  ...
  },
  {
    ...
    imageUrl: '/refreshments/blueberry-soda.jpg',
    available: true,
    stock: 99,
    displayOrder: 29,
  },
  {
    ...
    imageUrl: '/refreshments/strawberry-soda.jpg',
    available: true,
    stock: 99,
    displayOrder: 30,
  },
    ...
    imageUrl: '/refreshments/green-apple-soda.jpg',
    available: true,
    stock: 99,
    displayOrder: 31,
  },
  {
    ...
    imageUrl: '/refreshments/lemon-soda.jpg',
    available: true,
    stock: 99,
    displayOrder: 32,
  },
  {
    ...
    imageUrl: '/refreshments/lychee-soda.jpg',
    available: true,
    stock: 99,
    displayOrder: 33,
  },
  {
    ...
    imageUrl: '/refreshments/mango-soda.jpg',
    available: true,
    stock: 99,
    displayOrder: 34,
  },
  ...
  // Meals
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1598515214211-89d3c7373b94?q=80&w=400&h=300&fit=crop',
    available: true,
    stock: 99,
    popular: true,
    displayOrder: 35,
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1625944230219-4903e1f40822?q=80&w=400&h=300&fit=crop',
    available: true,
    stock: 99,
    popular: true,
    displayOrder: 36,
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1562967914-608f82629710?q=80&w=400&h=300&fit=crop',
    available: true,
    stock: 99,
    displayOrder: 37,
  },
